...
export default class MapResultsScreen extends Component {
  ...
  render() {
    ...
    for (var i=0; i < items_list.length; i++) {
        if (mapfilter.indexOf(items_list[i].document_key) == -1){
    ...
    return (
      <div className="AppScreen ShoppingOptionsScreen" style={baseStyle}>
        ...
        <Appbar className="navBar">
          <div className="title">Map Results</div>  <div className="backBtn" onClick={ (ev)=>{ this.props.appActions.goBack() } }><img src={btn_icon_back_shoppingoptions} alt="" style={{width: '50%'}} /></div>
        </Appbar>
